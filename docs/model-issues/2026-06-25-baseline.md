...
>   unchanged: **5 start events** (SYN-2).
> - **Model set:** 9 (overarching + 8 sub-pathways) since `v0.3.0-rc.1` — screening and
>   palliative-care were added after this snapshot. Issue 4's prefix split now reads: `aftercare`,
>   `overarching` and `palliative-care` use `bpmn2:`.
