...
German is the authoritative original; the English `acceptance-*.md` files are translations kept in
...
### Added
- English translations of all three documents (`acceptance-*.md`) alongside the German originals;
